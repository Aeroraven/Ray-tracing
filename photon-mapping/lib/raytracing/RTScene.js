...
var RTScene = exports.RTScene = function () {
    function RTScene(gl) {
        ...
        this.renderOutput = [new _WGLTexture.WGLTexture(gl, 800, 800, null), new _WGLTexture.WGLTexture(gl, 800, 800, null)];
    ...
    _createClass(RTScene, [{
        ...
        value: function render() {
            ...
            var doClear = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
