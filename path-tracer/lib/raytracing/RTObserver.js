...
var RTObserver = exports.RTObserver = function () {
    ...
    _createClass(RTObserver, [{
        ...
        value: function getCameraMatrix() {
            var x = _glMatrix.mat4.create();
            _glMatrix.mat4.mul(x, this.cam.getMatrix().proj, this.cam.getMatrix().view);
            return x;
        }
    }, {
        key: "getEye",
        ...
        value: function getRay(x, y) {
            ...
            _glMatrix.mat4.mul(projvecm, this.getCameraMatrix(), orgvecm);
            var projvec = new _Vec.Vec(projvecm[0] / projvecm[12], projvecm[4] / projvecm[12], projvecm[8] / projvecm[12]);
        ...
        value: function prepareShaderMap(shaderMap) {
            shaderMap.insert('raylt', this.getRay(-1, 1, this.dist + this.screenPos.z), _RTShaderVariableMap.RTShaderVariableMap.VEC3);
            shaderMap.insert('raylb', this.getRay(-1, -1, this.dist + this.screenPos.z), _RTShaderVariableMap.RTShaderVariableMap.VEC3);
            shaderMap.insert('rayrb', this.getRay(1, -1, this.dist + this.screenPos.z), _RTShaderVariableMap.RTShaderVariableMap.VEC3);
            shaderMap.insert('rayrt', this.getRay(1, 1, this.dist + this.screenPos.z), _RTShaderVariableMap.RTShaderVariableMap.VEC3);
